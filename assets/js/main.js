...
function navHighlighter() {
  ...
  sections.forEach((current) => {
    ...
    /* - If our current scroll position enters the space where current section on screen is, add .active class to corresponding navigation link, else to remove it  
       - To know which link needs and active class, we use sectionId variable we are getting while looping through sections as an selector */
